...
## 1. 팟캐스트 스크립트 (10분 분량, 2인 대화)
- 진행자(host)와 게스트(guest)의 자연스러운 대화
- 핵심 개념을 쉽게 설명
- 실생활 예시 포함
- 약 2000-2500자 (10분 분량)

## 2. 강의 슬라이드 (8-12장, 20분+ 강의)
- 각 슬라이드: 제목, 내용(불릿 포인트 3-5개), 나레이션
- 논리적 흐름
- 시각적으로 간결
...
- 학습자 수준에 맞는 쉬운 설명
- 실생활 예시 포함
- JSON 형식 엄수 (마크다운 코드 블록 없이 순수 JSON만)
"""
